...
public class LoadingDialog extends Dialog {
    ...
    private void initView() {
        ...
        textViewLoadingText.setTextSize(textViewLoadingTextSize);
        RelativeLayout.LayoutParams loadingParams = new RelativeLayout.LayoutParams(loadingSize, loadingSize);
        loadingParams.addRule(RelativeLayout.CENTER_HORIZONTAL);
        progressBar.setLayoutParams(loadingParams);
    }


    private int textViewLoadingTextSize = 16;

    public void setTextSize(int size) {
        this.textViewLoadingTextSize = size;
    }

    private int loadingSize = 100;
